...
const productMap: Record<string, { icon: string; fullName: string; emoji: string }> = {
    ...
    <Layout>
      ...
      <section className="bg-gradient-to-br from-primary to-primary/80 text-white py-16 md:py-24">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">{productInfo.fullName}</h1>
          <p className="text-xl text-white/90 max-w-2xl">
            Premium {productInfo.fullName.toLowerCase()} for industrial applications
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div>
              ...
              <p className="text-lg text-foreground/80 mb-6 leading-relaxed">
                Our {productInfo.fullName} is a premium-grade mineral product produced using advanced 
                processing techniques to meet international quality standards.
              </p>
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-foreground/80">Premium Grade Quality</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent font-bold">✓</span>
                  <span className="text-foreground/80">Consistent Specifications</span>
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-accent font-bold">✓</span>
                ...
                <li className="flex items-start gap-3">
                  <span className="text-accent font-bold">✓</span>
                  <span className="text-foreground/80">Bulk Orders Available</span>
                </li>
              </ul>
          ...
          <div className="bg-muted/30 rounded-lg p-8">
            <h3 className="text-2xl font-bold text-primary mb-6">Product Details</h3>
            <p className="text-lg text-foreground/80 mb-6">
              Detailed specifications, applications, and pricing information for {productInfo.fullName} 
              will be provided upon request.
            </p>
            <p className="text-foreground/70">
              Contact our sales team to learn more about this product, request samples, or get a competitive quote.
            </p>
          </div>

          {/* CTA */}
          <div className="mt-12 text-center p-8 bg-primary text-white rounded-lg">
            <h3 className="text-2xl font-bold mb-4">Interested in {productInfo.fullName}?</h3>
