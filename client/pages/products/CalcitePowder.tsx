        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div>
              ...
              <p className="text-lg text-foreground/80 mb-6 leading-relaxed">
                Our Calcite Powder is a pure, fine-ground product made from
                high-grade calcite mineral. Perfect for applications requiring
                bright, white, and chemically pure material.
              </p>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-foreground/70">
                    5-10 days from order confirmation
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-primary mb-2">
          ...
          <div className="text-center p-8 bg-primary text-white rounded-lg">
            <h3 className="text-2xl font-bold mb-4">
              Need High-Purity Calcite Powder?
            </h3>
