        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-lg text-foreground/80 mb-6 leading-relaxed">
              ...
              been the cornerstone of our success. We continue to expand our
              product range and improve our services to meet the evolving needs
              of our clients.
            </p>
            ...
            <p className="text-lg text-foreground/80 mb-6 leading-relaxed">
              To become the most trusted and innovative mineral supplier in the
              industry, delivering exceptional value to our customers worldwide.
            </p>
            ...
            <p className="text-lg text-foreground/80 mb-6 leading-relaxed">
              We are committed to providing superior quality minerals at
              competitive prices with outstanding customer service and timely
              delivery.
            </p>
            ...
            <div className="mt-12 p-6 bg-muted/30 rounded-lg">
              ...
              <p className="text-foreground/80 mb-4">
                Our modern manufacturing units are equipped with the latest
                technology to ensure consistent quality and efficiency. We
                maintain strict quality control procedures and comply with all
                international standards.
              </p>
              <p className="text-foreground/80">
                Our dedicated quality compliance team ensures every product
                meets the highest standards before it reaches our customers.
              </p>
            </div>
